...
#if defined(_OS_LINUX_) && defined(LLVM38)
// LLVM 3.7 doesn't seem to be happy about how we reuse local address here,
// and generates invalid `.eh_frame`.
